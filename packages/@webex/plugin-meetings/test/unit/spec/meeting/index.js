  ...
  describe('meeting index', () => {
    describe('Public Api Contract', () => {
      ...
      describe('#receiveTranscription', () => {
        ...
        /*  it('should invoke subscribe method to invoke the callback', async () => {
        ...
        /* describe('failure', () => {
          ...
          describe('guest join', () => {
            beforeEach(() => {
              ...
              MeetingUtil.joinMeetingOptions = sinon.stub().returns(Promise.reject());
            });
            ...
            it('should succeed when called again after IntentToJoinError error', async () => {
              ...
              MeetingUtil.joinMeetingOptions = sinon.stub().returns(Promise.resolve(true));
      ...
      describe('#addMedia', () => {
        ...
        /* it('if an error occurs after media request has already been sent, and the user waits until the server kicks them out, a UserNotJoinedError should be thrown when attempting to addMedia again', async () => {
          ...
          await meeting.addMedia().catch((err) => {
            expect(err.message).toBe('User currently not in meeting. Please join a meeting before adding media.');
          });
        }); */
        ...
        /* it('if an error occurs after media request has already been sent, and the user does NOT wait until the server kicks them out, the user should be able to addMedia successfully', async () => {
          ...
          return meeting.addMedia()
            .then(() => {
              assert.calledTwice(meeting.roap.sendRoapMediaRequest);
          });
        }); */
      ...
      describe('#setMeetingQuality', () => {
        ...
        it('should call setRemoteQualityLevel', () =>
          meeting.setMeetingQuality(CONSTANTS.QUALITY_LEVELS.LOW).then(() => {
        ...
        it('should call setLocalVideoQuality', () =>
          meeting.setMeetingQuality(CONSTANTS.QUALITY_LEVELS.LOW).then(() => {
