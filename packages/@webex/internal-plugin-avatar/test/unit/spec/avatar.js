  ...
  describe('#retrieveAvatarUrl()', () => {
      ...
      describe('when options.hideDefaultAvatar is true', () => {
        it('returns null if it is a default avatar and options.hideDefaultAvatar is true', () => {
          ...
          const deferred = avatar.retrieveAvatarUrl('88888888-4444-4444-4444-aaaaaaaaaaa0', {
            hideDefaultAvatar: true,
          });

          return deferred.then((res) => assert.isNotOk(res));
        });
    ...
    describe('when retrieving multiple items', () => {
      ...
      /* it('rejects each avatar missing from the response', () => {
        ...
        return Promise.all([
          ...
          .then(([result]) => {
            ...
            return avatar.retrieveAvatarUrl('88888888-4444-4444-4444-aaaaaaaaaaa1');
          })
          .catch((e) => {
            expect(e.message).toBe('Failed to retrieve avatar');
      ...
      it('retrieves avatar urls for homogenous, non-default sizes', () => {
        ...
        return Promise.all([
          avatar
            .retrieveAvatarUrl('88888888-4444-4444-4444-aaaaaaaaaaa0', {size: 40})
            .then((result) =>
              assert.deepEqual(
                result,
      ...
      it('retrieves avatar urls for homogenous, non-standard sizes', () => {
        ...
        return Promise.all([
          avatar
            .retrieveAvatarUrl('88888888-4444-4444-4444-aaaaaaaaaaa0', {size: 100})
            .then((result) =>
              assert.deepEqual(
                result,
